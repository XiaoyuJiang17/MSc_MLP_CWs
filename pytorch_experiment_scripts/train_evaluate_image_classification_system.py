...
if args.block_type == 'conv_block':
...
elif args.block_type == 'convBN_block':
    ...
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlock_BN
elif args.block_type == 'convRC_block': # This is my own (extra) implementation of RC 
    processing_block_type = ConvolutionalProcessingBlock_RC
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlock
else:
...
conv_experiment = ExperimentBuilder(learning_rate=args.learning_rate,
