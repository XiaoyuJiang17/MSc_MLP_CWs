...
# This is my own (extra) implementation of RC,the result based on this will be used in table 
class ConvolutionalProcessingBlock_RC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_RC, self).__init__()
